...
extension CodexService {
    ...
    func performSecureHandshake() async throws {
        ...
        guard serverHello.macDeviceId == macDeviceId else {
            throw CodexSecureTransportError.invalidHandshake("The bridge reported a different Mac identity for this paired bridge.")
        }
    ...
    func rememberBridgePairing(_ payload: CodexPairingQRPayload) {
