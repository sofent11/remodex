...
extension CodeRoverService {
    ...
    private func existingCommandExecutionRow(threadId: String, itemId: String) -> ChatMessage? {
    ...
    private func handleLegacyCodeRoverEnvelopeEvent(_ paramsObject: IncomingParamsObject?) -> Bool {
        ...
        return handleLegacyCodeRoverEventType(
            eventType: eventType,
            payload: msgObject,
            paramsObject: paramsObject
        )
    ...
    private func handleLegacyCodeRoverNamedEvent(
        method: String,
        paramsObject: IncomingParamsObject?
    ) -> Bool {
    ...
    private func handleLegacyCodeRoverEventType(
        eventType: String,
    ...
    private func appendEssentialActivityLine(threadId: String, turnId: String?, line: String) {
        ...
        recentActivityLineByThread[dedupeKey] = CodeRoverRecentActivityLine(line: trimmedLine, timestamp: now)
